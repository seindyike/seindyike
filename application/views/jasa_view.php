...
<div class="head-bread">
    ...
    <div class="container">
            <div class="col-md-6">
              <p align="justify">Form jasa latihan digunakan untuk melakukan pendaftaran latihan fotografer yang akan dilaksanakan ditempat kami,
            ...
            <div class="col-md-6">
                     <form data-parsley-validate action="<?php echo base_url('jasa/simpan')?>" method="post" class="form-horizontal">
                         <div class="form-group">
                           ...
                           <select class="form-control" name="jenis_fotografer" required>
